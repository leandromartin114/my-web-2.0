...
export const ProjectsSection = () => {
    ...
    const { projects } = useContext(LeanContext)

    return (
        <section id='projects'>
            <div className='hidden lg:grid w-full h-screen px-4 md:px-8 grid-cols-2 2xl:flex 2xl:gap-44 2xl:justify-center items-center'>
                <motion.div
            ...
            <div className='h-screen flex flex-col gap-10 py-5 items-center lg:hidden'>
                <SectionTitle>projects</SectionTitle>
